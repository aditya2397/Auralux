...
void loadAllSprites()
{
	...
	/* suns */
	loadSprite(BLUE_SUN_1, "gfx/BLUE_SUN_1.png");
	loadSprite(BLUE_SUN_2, "gfx/BLUE_SUN_2.png");
	loadSprite(BLUE_SUN_3, "gfx/BLUE_SUN_3.png");
	loadSprite(GREEN_SUN_1, "gfx/GREEN_SUN_1.png");
	loadSprite(GREEN_SUN_2, "gfx/GREEN_SUN_2.png");
	loadSprite(GREEN_SUN_3, "gfx/GREEN_SUN_3.png");
	loadSprite(ORANGE_SUN_1, "gfx/ORANGE_SUN_1.png");
	loadSprite(ORANGE_SUN_2, "gfx/ORANGE_SUN_2.png");
	loadSprite(ORANGE_SUN_3, "gfx/ORANGE_SUN_3.png");
	loadSprite(PURPLE_SUN_1, "gfx/PURPLE_SUN_1.png");
	loadSprite(PURPLE_SUN_2, "gfx/PURPLE_SUN_2.png");
	loadSprite(PURPLE_SUN_3, "gfx/PURPLE_SUN_3.png");
	/*
	*/
	loadSprite(GRAY_SUN, "gfx/GRAY_SUN.png");
	
	/* rings */
	loadSprite(RING_1, "gfx/RING_1.png");
	loadSprite(RING_2, "gfx/RING_2.png");
	loadSprite(SELECT_RING, "gfx/SELECT_RING.png");
